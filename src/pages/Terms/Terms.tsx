export const Terms: React.FC = () => {
  return (
    <>
      ...
      <h2>THE STYLING HERE IS UGLY CAUSE I CAN'T BE BOTHERED :)</h2>
      ...
      <p>For the purposes of these Terms and Conditions:</p>
          ...
          <p>
            ...
            this Agreement) refers to UnnamedPrivacyCo, 123 Real Road, Real
            Place, 0987.
          </p>
          ...
          <p>
            <strong>Website</strong> refers to UnnamedPrivacyCo, accessible from{" "}
            <a
              href="https://UnnamedPrivacyCo.com"
            >
              https://UnnamedPrivacyCo.com
            </a>
          </p>
      ...
      <ul>
        <li>
          <p>By email: realemail@unnamedprivacy.co</p>
        </li>
        <li>
          <p>By phone number: +61 888 444</p>
        </li>
      </ul>
    </>
  );
